    ...
    <div className='flex gap-4 justify-center mb-8'>
      ...
      <div className='flex-basis-1/3 flex-grow -mt-5'>
        <div className='flex flex-col h-full relative'> 
          <p className='blured-image h-[113px] absolute w-full top-0 left-0 right-0 rounded-t-3xl text-3xl font-semibold text-primary flex items-center justify-center'>{currentCard?.word}</p>
