      ...
      <div className="navigation__content px-4 py-4 font-['Inter var'] text-[18px] tracking-[-2%] text-[#f5f5f5]">
        <ul className="navigation__list flex flex-col gap-10">
          <li className="navigation__item flex flex-nowrap items-center gap-2 hover:opacity-80 cursor-pointer duration-300">
            ...
            />
            <Link to={ROUTE_HOME} className="navigation__link">
              Home
            </Link>
          </li>
          <li className="navigation__item flex flex-nowrap items-center gap-2 hover:opacity-80 cursor-pointer duration-300">
            <img
              ...
              className="navigation__img"
            />
            <Link to={ROUTE_PROFILE} className="navigation__link">
              Personal Account
            </Link>
          </li>
          <li className="navigation__item flex flex-nowrap items-center gap-2 hover:opacity-80 cursor-pointer duration-300">
            <img
              ...
              className="navigation__img"
            />
            <Link to={ROUTE_CARD_GAME} className="navigation__link">
              Play the Game
            </Link>
          </li>
          <li className="navigation__item flex flex-col">
            <div
              className="flex flex-nowrap items-center gap-2 mb-3 cursor-pointer"
              onClick={toggleList}
            >
              <img
                src={user}
                ...
                className="navigation__img"
              />
              <p className="navigation__link hover:opacity-80  duration-300">
                Authorization
              </p>
              <img
                ...
                height={"24px"}
                alt=""
                className="navigation__img ml-auto"
              />
            </div>
            {isCollapsed && (
